...
openxlsx::write.xlsx(atc_maksakahjustus, file='atc_maksakahjustus.xlsx', col.names = TRUE)
```
**Tabel 2. Aastate lõikes retseptid ja unikaalsed patsiendid, kes on saanud ravimeid, mille toimeaine on maksakahjustuse riskiga (ATC koodi järgi) ja aasta ei ole 2020.**
...
openxlsx::write.xlsx(retseptidpatsiendidstartdate, file='retseptidpatsiendidstartdate.xlsx', col.names = TRUE)
```
...
openxlsx::write.xlsx(toimeaine, file='toimeaine.xlsx', col.names = TRUE)
```
...
openxlsx::write.xlsx(patsiendid_retseptid_aastate_loikes, file='patsiendid_retseptid_aastate_loikes.xlsx', col.names = TRUE)
```
...
openxlsx::write.xlsx(hkkood, file='hkkood.xlsx', col.names = TRUE)
```
...
openxlsx::write.xlsx(hk_2018, file='hk_2018.xlsx', col.names = TRUE)
```
...
openxlsx::write.xlsx(dl, file='dl.xlsx', col.names = TRUE)
```
...
openxlsx::write.xlsx(dl_2018, file='dl_2018.xlsx', col.names = TRUE)
```
...
openxlsx::write.xlsx(analyys_kpv, file='analyys_kpv.xlsx', col.names = TRUE)
```
...
openxlsx::write.xlsx(analyysid_enne_ravi, file='analyysid_enne_ravi.xlsx', col.names = TRUE)
```
...
openxlsx::write.xlsx(patsient_diagnoos, file='patsient_diagnoos.xlsx', col.names = TRUE)
...
openxlsx::write.xlsx(sugu_vanus, file='sugu_vanus.xlsx', col.names = TRUE)
```
...
openxlsx::write.xlsx(mh_enne_ravi, file='mh_enne_ravi.xlsx', col.names = TRUE)
```
**Tabel 14. Maksahaigus diagnoositud ravimi kasutamise ajal või 30 päeva pärast ravimi kasutamise lõpetamist.** 
...
openxlsx::write.xlsx(mh_ravi_ajal, file='mh_ravi_ajal.xlsx', col.names = TRUE)
```
...
openxlsx::write.xlsx(retseptid, file='retseptid.xlsx', col.names = TRUE)
...
openxlsx::write.xlsx(alat_value1, file='alat_value1.xlsx', col.names = TRUE)
...
openxlsx::write.xlsx(alat_value, file='alat_value.xlsx', col.names = TRUE)
```
...
openxlsx::write.xlsx(asat_value1, file='asat_value1.xlsx', col.names = TRUE)
...
openxlsx::write.xlsx(asat_value, file='asat_value.xlsx', col.names = TRUE)
```
...
openxlsx::write.xlsx(atc_d, file='atc_d.xlsx', col.names = TRUE)
